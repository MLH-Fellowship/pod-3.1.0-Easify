//rendering content
const postContent = (pageURL) => {
    return `
     <div id="notfound">
        <div class="notfound">
            <div class="notfound-404">
                <h1>Oops!</h1>
                <h2>It's work time, dear!</h2>
            </div>
            <a href="#">Go back to work :)</a>
        </div>
    </div>
    `
}
...
//blocking content
access_url = window.location.hostname
document.head.innerHTML = postHeader();
document.body.innerHTML = postContent(access_url)